...
\begin{longtable}{p{4.5cm} p{8cm} *{7}{>{\centering\arraybackslash}p{1.1cm}}}
\caption{Feature comparison across vasculature analysis tools.}
...
\bottomrule
\endfoot
\input"| xlsx2csv ../../Feature_Comparison.xlsx | python3 gen_feature_csv.py"
\end{longtable}
\end{landscape}
