...
\affil{
  ...
  %Module title: [either Project Biomedical Network Science or
  % Network Medicine]\\% For project reports and student papers
  %Semester: [specify semster during which you attended the
  % module]\\% For project reports and student papers
