...
classification on the HRF dataset. The remainder of this report is
...
parallel batch processing. On a 12-thread homogeneous workstation,
...
\section{Supplementary tables}\label{appendix:tables}
...
\begin{answerbox}{Task: Literature review and analysis}
  \textit{``I used ResearchRabbit to identify and explore relevant
  literature.''}
\end{answerbox}
